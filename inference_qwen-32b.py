...
def process_answers(df, prompt_template=FEW_SHOT_TEMPLATE):
    ...
    temp_file_path = "output/temp_choices_answer_llama2.csv"
    start_index = 0
...
def main(template):
    ...
    submission.to_csv("output/submission_llama2.csv", index=False)
    print("Submission saved to output/submission_qwen_32b.csv")
